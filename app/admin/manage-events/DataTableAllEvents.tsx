...
import { LeaderboardEntry, TagsEvent } from "@/app/types";
import { DataTableToolbar } from "./data-table-toolbar-allevents";
import { DataTablePagination } from "@/app/components/data-table-pagination";

interface DataTableProps {
  columns: ColumnDef<TagsEvent>[];
  data: TagsEvent[];
  sort?: string;
}

export const DataTableAllEvents: React.FC<DataTableProps> = ({
  columns,
  data,
  sort,
}) => {
